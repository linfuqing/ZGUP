...
namespace ZG
{
    ...
    public class PinYinConverter
    {
        ...
        public static String Get(Char ch)
        {
            ...
            arr = Encoding.Convert(Encoding.Default, GB2312Encoding.Instance, arr);
        ...
        public static string Get(string str, int startIndex = 0, int length = 0)
        {
            if (string.IsNullOrEmpty(str))
                return string.Empty;

            length = length > 0 ? length : str.Length - startIndex;
            var sb = new StringBuilder(length * 10);
            var chs = str.ToCharArray(startIndex, length);
